...
let deletkanal = "917480507812491304"
...
client.on("messageDelete", async (message, channel) => {
  if(message.author.bot || message.channel.type === "dm") return;
    ...
    client.on("message",msg=>{if (msg.content.includes("<@!783605631164350475> ") ) return msg.delete() && msg.channel.send(`Hey! Bu kullanıcıyı etiketlemek yasaktır.`)})
...
client.on('ready', () => {
  client.channels.cache.get('928018599371747358').join();
})
